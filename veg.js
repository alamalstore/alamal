...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const productList = [
        ...
        { name: ".ليمون", price: 500, img: "img/ei_1731755591215-removebg-preview.jpg", description: "2حبة ليمون ب" },
        { name: "..ليمون", price: 1000, img: "img/ei_1731755591215-removebg-preview.jpg", description: "4 حبات ليمون ب" },
        { name: "بصل ابيض", price: 3000, img: "img1/IMG_٢٠٢٥٠٢١٦_١٠٣٢٣٣_(600_x_600_pixel) (2).jpg", description: "كيلوا بصل ابيض" },
        { name: ".بصل ابيض", price: 1500, img: "img1/IMG_٢٠٢٥٠٢١٦_١٠٣٢٣٣_(600_x_600_pixel) (2).jpg", description: "نص كيلوا بصل ابيض" },
        ...
        { name: "..فلفليه", price: 2000, img: "img/image_fx_ (3) (1).jpg", description: "ربع كيلوا فلفليه" },
        { name: "..فلفليه", price: 1000, img: "img/image_fx_ (3) (1).jpg", description: "نص ربع كيلوا فلفليه" },
        { name: "جرجير", price: 1000, img: "img/watercress-4257303_1920 (1).jpg", description: "جرجير طازج" },
        { name: "جزر", price: 2000, img: "img/carrots-673184_1920 (1).jpg", description: "ربطة الجزر" },
