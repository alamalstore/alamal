...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const productList = [
        ...
        { name: ".لحمة عجالي", price: 6500, img: "img/ai-generated-8864309_1280 (1).png", description: "نص لحمة عجالي" },
        { name: "..لحمة عجالي", price: 3300, img: "img/ai-generated-8864309_1280 (1).png", description: "ربع لحمه عجالي" },
        ...
        { name: "كبدة عجالي", price: 18000, img: "img1/ei_1734972675443-removebg-preview.png", description: "كيلو كبدة عجالي" },
        { name: "كبدة عجالي.", price: 9000, img: "img1/ei_1734972675443-removebg-preview.png", description: "نص كيلو " },
        { name: "كبدة عجالي..", price: 4500, img: "img1/ei_1734972675443-removebg-preview.png", description: "ربع كيلو كبدة" },
        { name: "دجاج", price: 12000, img: "img1/9B7AB858-ED5E-45D8-9974-888B513E12CE.png", description: "كيلو دجاج" },
        { name: "دجاج.", price: 6000, img: "img1/9B7AB858-ED5E-45D8-9974-888B513E12CE.png", description: "نص كيلو دجاج" },
        ...
        { name: "رجله خضره", price: 2000, img: "img1/ei_1731608358596-removebg-preview.png", description: " رجله خضره يمكنك الاختيار عدة مرات" },
        ...
        { name: "دقيق سيقا", price: 2200, img: "img1/ei_1731608054582-removebg-preview.png", description: " (كيلو دقيق (انتاج شركة سيقا" },
        { name: "دقيق سمولينا", price: 2200, img: "img1/ei_1734856532272-removebg-preview.png", description: "دقيق سمولينا فاخر" },
        ...
        { name: "سكر", price: 2500, img: "img1/ei_1731587279355-removebg-preview.png", description: "كيلو سكر" },
        { name: ".سكر", price: 1300, img: "img1/ei_1731587279355-removebg-preview.png", description: "نص كيلو سكر" },
        ...
        { name: "كبكبي", price: 7000, img: "img1/ei_1731600582219-removebg-preview.png", description: "ملوة كبكبي" },
        { name: ".كبكبي", price: 3500, img: "img1/ei_1731600582219-removebg-preview.png", description: "نص ملوه كبكبي" },
        { name: "..كبكبي", price: 1800, img: "img1/ei_1731600582219-removebg-preview.png", description: "ربع ملوة كبكبي" },
        ...
        { name: "فاصوليا", price: 5000, img: "img1/ei_1731592911797-removebg-preview.png", description: "كيلو فاصوليا" },
        { name: ".فاصوليا", price: 2500, img: "img1/ei_1731592911797-removebg-preview.png", description: " نص كيلو فاصوليا" },
        { name: "..فاصوليا", price: 1300, img: "img1/ei_1731592911797-removebg-preview.png", description: "ربع كيلو فاصوليا" },
        { name: "عدس", price: 3600, img: "img1/ei_1731592849739-removebg-preview.png", description: "كيلو عدس" },
        { name: ".عدس", price: 1800, img: "img1/ei_1731592849739-removebg-preview.png", description: "نص كيلو عدس" },
        { name: "..عدس", price: 900, img: "img1/ei_1731592849739-removebg-preview.png", description: "ربع كيلو عدس" },
        { name: "رز", price: 3000, img: "img1/ei_1731592875777-removebg-preview.png", description: "كيلو رز" },
        { name: ".رز", price: 1500, img: "img1/ei_1731592875777-removebg-preview.png", description: "نص كيلو رز" },
        { name: "..رز", price: 800, img: "img1/ei_1731592875777-removebg-preview.png", description: "ربع كيلو رز" },
        ...
        { name: "كسبره", price: 1000, img: "img1/ei_1731587888826-removebg-preview.png", description: "يمكنك الاختيار عدة مرات" },
        { name: "كسبره مسحونه", price: 1000, img: "img1/ei_1731587592367-removebg-preview.png", description: "يمكنك الاختيار عدة مرات" },
        ...
        { name: "قرفه", price: 1000, img: "img1/ei_1731587655490-removebg-preview.png", description: "يمكنك الاختيار عدة مرات" },
        { name: "قرنفل", price: 1000, img: "img1/ei_1731587348599-removebg-preview.png", description: "يمكنك الاختيار عدة مرات(اقل سعر)" },
        { name: "شمار", price: 1000, img: "img1/ei_1731587721125-removebg-preview.png", description: "يمكنك الاختيار عدة مرات" },
        { name: "كمون(الحبه السودا)", price: 1000, img: "img1/ei_1731588860551-removebg-preview.png", description: "يمكنك الاختيار عدة مرات" },
        ...
        { name: "عصير مانجو", price: 28000, img: "img1/ei_1734797721915-removebg-preview.png", description: "عصير مانجو بلومينج حجم كبير" },
        { name: "عصير مانجو.", price: 18000, img: "img1/ei_1734797721915-removebg-preview.png", description: "عصير مانجو بلومينج حجم اصغير" },
        { name: "عصير برتقال", price: 28000, img: "img1/ei_1734797854127-removebg-preview.png", description: "عصير برتقال بلومينج حجم كبير" },
        { name: "عصير برتقال.", price: 18000, img: "img1/ei_1734797854127-removebg-preview.png", description: "عصير برتقال بلومينج حجم اصغير" },
        { name: "عصير اناناس", price: 28000, img: "img1/ei_1734797778852-removebg-preview.png", description: "عصير اناناس بلومينج حجم كبير" },
        { name: "عصير اناناس.", price: 18000, img: "img1/ei_1734797778852-removebg-preview.png", description: "عصير انانس بلومينج حجم اصغير" },
        { name: "عصير فواكة استوائيه", price: 28000, img: "img1/ei_1734797809199-removebg-preview.png", description: "حجم كبير" },
        { name: "عصير فواكة استوائيه.", price: 18000, img: "img1/ei_1734797809199-removebg-preview.png", description: "حجم اصغير" },
        { name: "عصير مانجو-", price: 10000, img: "img1/ei_1734856419214-removebg-preview.png", description: "حجم اكبر" },
        { name: "عصير مانجو--", price: 8000, img: "img1/ei_1734856419214-removebg-preview.png", description: "حجم اقل" },
        { name: "عصير برتقال-", price: 10000, img: "img1/ei_1734856345668-removebg-preview.png", description: "حجم اكبر" },
        { name: "عصير برتقال--", price: 8000, img: "img1/ei_1734856345668-removebg-preview.png", description: "حجم اقل" },
        { name: "عصير اناناس-", price: 10000, img: "img1/ei_1734856388728-removebg-preview.png", description: "حجم اكبر" },
        { name: "عصير اناناس--", price: 8000, img: "img1/ei_1734856388728-removebg-preview.png", description: "حجم اقل" },
        { name: " صلصه مجانا", price: 500, img: "img1/ei_1731593282850-removebg-preview.png", description: "ظرف صلصله مجانا يمكنك اختيار عدة ظروف" },
        { name: "صلصه", price: 3600, img: "img1/ei_1731600621391-removebg-preview.png", description: "علبة صلصة الفراشه" },
        { name: ".صلصه", price: 3600, img: "img1/ei_1731600652049-removebg-preview.png", description: "علبة صلصة سعيد" },
        { name: "زيت فول", price: 1000, img: "img1/ei_1731592819883-removebg-preview.png", description: " يمكنك الاختيار حسب سعرك او عدة مرات"  },
        { name: ".زيت فول", price: 2000, img: "img1/ei_1731592819883-removebg-preview.png", description: "يمكنك الاختيار حسب سعرك او عدة مرات" },
        { name: " زيت تحمير", price: 1000, img: "img1/ei_1731592819883-removebg-preview.png", description: "يمكنك الاختيار حسب سعرك او عدة مرات" },
        { name: ".زيت تحمير", price: 2000, img: "img1/ei_1731592819883-removebg-preview.png", description: "يمكنك الاختيار حسب سعرك او عدة مرات" },
        { name: "زيت فول-", price: 20000, img: "img1/ei_1734856577503-removebg-preview.png", description: "زيت فول نقي" },
        { name: "زيت كنوز", price: 5000, img: "img1/ei_1734807243575-removebg-preview (1).png", description: "زيت كنوز" },
        { name: "زيت الوافي", price: 5000, img: "img/1731592288427.jpg", description: "زيت الوافي 900مل" },
        { name: ".زيت الوافي", price: 19000, img: "img1/ei_1731592752318-removebg-preview.png", description: "زيت الوافي 4لتر" },
        { name: "خميره", price: 300, img: "img/ei_1731749366170-removebg-preview.png", description: "ظرف يمكنك الاختيار عدة مرات" }, 
        { name: "باكنج باودر", price: 800, img: "img1/ei_1731755615723-removebg-preview.png", description: "ظرف يمكنك الاختيار عدة مرات" }, 
        ...
        { name: "كستر", price: 800, img: "img1/ei_1731755822410-removebg-preview.png", description: "ظرف كستر" },
        ...
        { name: " بن حب", price: 6500, img: "img1/ei_1731587859083-removebg-preview.png", description: "بن رطل" },
        { name: " .بن حب", price: 3300, img: "img1/ei_1731587859083-removebg-preview.png", description: "بن نص رطل" },
        { name: "..بن حب", price: 1700, img: "img1/ei_1731587859083-removebg-preview.png", description: "بن ربع رطل" },
        { name: "بن مسحون", price: 9000, img: "img1/ei_1731587685380-removebg-preview.png", description: "رطل بن مسحون" },
        { name: ".بن مسحون", price: 4500, img: "img1/ei_1731587685380-removebg-preview.png", description: "نص رطل بن مسحون" },
        { name: "..بن مسحون", price: 2300, img: "img1/ei_1731587685380-removebg-preview.png", description: "ربع رطل بن مسحون" },
        { name: "شاي تعبيه", price: 1000, img: "img/ei_1731587544800-removebg-preview (1).png", description: "نص ربع" },
        { name: "شاي الغزالتين", price: 2000, img: "img1/ei_1731601395773-removebg-preview (1).png", description: "ربع شاي الغزالتين" },
        { name: ".شاي الغزالتين", price: 3800, img: "img1/ei_1731601395773-removebg-preview (1).png", description: "نص رطل" },
        { name: "..شاي الغزالتين", price: 7500, img: "img1/ei_1731601395773-removebg-preview (1).png", description: "رطل شاي الغزالتين" },
        { name: "شعريه نوبو", price: 1300, img: "img1/ei_1731607995331-removebg-preview.png", description: "شعريه نوبو" },
        { name: "مكرونه نوبو", price: 1300, img: "img1/ei_1731607972769-removebg-preview.png", description: "مكرونه كوع" },
        { name: "مكرونه اسباجتي", price: 1300, img: "img1/ei_1731608036079-removebg-preview (1).png", description: "اسباجتي" },
        ...
        { name: "طحنية الوافي", price: 11500, img: "img1/ei_1731607886849-removebg-preview.png", description: "حجم كبير" },
        { name: ".طحنية الوافي", price:6000, img: "img/ei_1731750044887-removebg-preview.png", description: "حجم وسط" },
        { name: "طحنية الوطنيه", price: 11500, img: "img1/ei_1731607898994-removebg-preview.png", description: "حجم كبير" },
        { name: ".طحنية الوطنيه", price: 6000, img: "img1/ei_1731607874744-removebg-preview.png", description: "حجم وسط" },
        ...
        { name: "اندومي ", price: 500, img: "img1/ei_1731780282744-removebg-preview.png", description: "اندومي خضار يمكنك الاختيار عدة مرات" },
        ...
        { name: "صابون غسيل", price: 800, img: "img1/ei_1731749244152-removebg-preview.png", description: "صابون غسيل استار" },
        ...
        { name: "صابون حمام", price: 2000, img: "img1/ei_1731752022045-removebg-preview.png", description: "صابون lux حجم كبير" },
        { name: "صابون حمام.", price: 1500, img: "img1/ei_1731752022045-removebg-preview.png", description: "صابون lux حجم وسط" },
        { name: "صابون حمام..", price: 1000, img: "img1/ei_1731752022045-removebg-preview.png", description: "صابون lux حجم صغير" },
        { name: "صابون حمام,", price: 1500, img: "img1/ei_1731752048693-removebg-preview.png", description: "صابون لايف بوي وسط" },
        { name: ".صابون حمام", price: 1000, img: "img1/ei_1731752048693-removebg-preview.png", description: "صابون لايف بوي صغير" },
        ...
        { name: "صابون بشرى..", price: 10000, img: "img1/ei_1734856457993-removebg-preview.png", description: "صابون بشرى حجم كبير" },
        { name: "صابون فيبا", price: 2000, img: "img1/ei_1734807182863-removebg-preview.png", description: "صابون فيبا الأصلي" },
        { name: " صابون امارلس", price: 1000, img: "img1/ei_1734856612142-removebg-preview.png", description: "حجم صغير" },
        ...
        { name: "معجون اسنان", price: 3500, img: "img1/ei_1731751974015-removebg-preview.png", description: "معجون سنجل حجم كبير" },
