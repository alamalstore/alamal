...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const productList = [
        ...
        { name: "لحمة عجالي", price: 14000, img: "img/ei_1735077637290-removebg-preview.jpg", description: "كيلو لحمة عجالي" },
        { name: ".لحمة عجالي", price: 7000, img: "img/ei_1735077637290-removebg-preview.jpg", description: "نص لحمة عجالي" },
        { name: "..لحمة عجالي", price: 3500, img: "img/ei_1735077637290-removebg-preview.jpg", description: "ربع لحمه عجالي" },
        { name: "لحمة ضان", price: 25000, img: "img/meat-3359248_1920 (1).jpg", description: "كيلو لحمة ضان" },
        { name: ".لحمة ضان", price: 12500, img: "img/meat-3359248_1920 (1).jpg", description: "نص لحمة ضان" },
        { name: "..لحمة ضان", price: 6500, img: "img/meat-3359248_1920 (1).jpg", description: "ربع لحمة ضان" },
        { name: "لحمة عجالي مفرومه", price: 18000, img: "img1/2018_5_28_21_59_16_26 (1).jpg", description: "كيلو مفرومه" },
        { name: "لحمة عجالي مفرومه.", price: 9000, img: "img1/2018_5_28_21_59_16_26 (1).jpg", description: "نص كيلو مفرومه" },
        { name: "لحمة عجالي مفرومه..", price: 4500, img: "img1/2018_5_28_21_59_16_26 (1).jpg", description: "ربع كيلو مفرومه" },
        ...
        { name: "دجاج", price: 12500, img: "img1/9B7AB858-ED5E-45D8-9974-888B513E12CE.jpg", description: "كيلو دجاج" },
        { name: "دجاج.", price: 6500, img: "img1/9B7AB858-ED5E-45D8-9974-888B513E12CE.jpg", description: "نص كيلو دجاج" },
        { name: "بطاطس", price: 3500, img: "img/potato-3440360_1920 (1).jpg", description: "كيلو بطاطس" },
        { name: ".بطاطس", price: 1800, img: "img/potato-3440360_1920 (1).jpg", description: "نص كيلو بطاطس" },
        { name: "بامبي", price: 3000, img: "img/1730965247587.jpg", description: "كيلو بامبي" },
        { name: ".بامبي", price: 1500, img: "img/1730965247587.jpg", description: "نص كيلو بامبي" },
        ...
        { name: "اسود", price: 1500, img: "img/image_fx_.jpg", description: "نص كيلو اسود" },
        { name: "قرع", price: 2500, img: "img/image_fx_ (1) (1).jpg", description: "كيلوه قرع" },
        { name: ".قرع", price: 1500, img: "img/image_fx_ (1) (1).jpg", description: "نص كيلو قرع" },
        { name: "كوزه", price: 2500, img: "img/image_fx_ (2) (1).jpg", description: "كيلو كوسه" },
        { name: ".كوزه", price: 1500, img: "img/image_fx_ (2) (1).jpg", description: "نص كيلو كوسه" },
        ...
        { name: ".ليمون", price: 500, img: "img/ei_1731755591215-removebg-preview.jpg", description: "2حبات ليمون ب" },
        { name: "..ليمون", price: 1000, img: "img/ei_1731755591215-removebg-preview.jpg", description: "4حبات ليمون ب" },
        { name: "بصل ابيض", price: 3500, img: "img1/IMG_٢٠٢٥٠٢١٦_١٠٣٢٣٣_(600_x_600_pixel) (2).jpg", description: "اخضار احسب سعرك" },
        { name: ".بصل ابيض", price: 1800, img: "img1/IMG_٢٠٢٥٠٢١٦_١٠٣٢٣٣_(600_x_600_pixel) (2).jpg", description: "اخضار احسب سعرك" },
        
        { name: "فلفليه", price: 8000, img: "img/image_fx_ (3) (1).jpg", description: "كيلوا فلفليه" },
        { name: ".فلفليه", price: 4000, img: "img/image_fx_ (3) (1).jpg", description: "نص كيلوا فلفليه" },
        { name: "..فلفليه", price: 2000, img: "img/image_fx_ (3) (1).jpg", description: "ربع كيلوا" },
        { name: "..فلفليه", price: 1000, img: "img/image_fx_ (3) (1).jpg", description: "نص ربع" },
        { name: "جرجير", price: 500, img: "img/watercress-4257303_1920 (1).jpg", description: "جرجير طازج" },
        { name: "جزر", price: 2000, img: "img/carrots-673184_1920 (1).jpg", description: "ربطة جزر" },
        { name: "خيار", price: 3000, img: "img/cucumber-7259270_1920 (1).jpg", description: "كيلو خيار" },
        { name: ".خيار", price: 15000, img: "img/cucumber-7259270_1920 (1).jpg", description: "نص كيلو خيار" },
        { name: "..خيار", price: 1000, img: "img/cucumber-7259270_1920 (1).jpg", description: "ربع كيلو خيار" },
        { name: "عجور", price: 1000, img: "img/image_fx_ (4).jpg", description: "عجوره واحدة ب" },
        { name: "تفاح", price: 12000, img: "img/ei_1734696807142-removebg-preview.jpg", description: "دسته 12 حبه" },
        ...
        { name: ".جوافه", price: 3500, img: "img/ei_1734696960682-removebg-preview.jpg", description: "كيلو جوافه" },
        { name: "جوافه", price: 1800, img: "img/ei_1734696960682-removebg-preview.jpg", description: "نص كيلو جوافه" },
        { name: "جوافه.", price: 1000, img: "img/ei_1734696960682-removebg-preview.jpg", description: "ربع كيلو جوافه" },
        ...
        { name: "برتقال", price: 6000, img: "img/ei_1734696846138-removebg-preview.jpg", description: "دستة برتقال" },
        { name: "برتقال.", price: 3000, img: "img/ei_1734696846138-removebg-preview.jpg", description: "نص دسته برتقال" },
        { name: "برتقال..", price: 1500, img: "img/ei_1734696846138-removebg-preview.jpg", description: "ربع دسته برتقال" },
        { name: "جريب", price: 8000, img: "img/ei_1734696921137-removebg-preview.jpg", description: "دستة جريب" },
        { name: "جريب.", price: 4000, img: "img/ei_1734696921137-removebg-preview.jpg", description: "نص دسته" },
        { name: "جريب..", price: 2000, img: "img/ei_1734696921137-removebg-preview.jpg", description: "ربع دسته" },
        ...
        { name: "تمر", price: 5000, img: "img/ei_1731587410119-removebg-preview.jpg", description: "ملوة تمر" },
        { name: ".تمر", price: 2500, img: "img/ei_1731587410119-removebg-preview.jpg", description: "نص ملوة تمر" },
        ...
        { name: "عدسيه", price: 2000, img: "img/pigean1 (1).jpg", description: "ربع ملوة" },
        { name: "فاصوليا", price: 6000, img: "img1/ei_1731592911797-removebg-preview.jpg", description: "كيلو فاصوليا" },
        { name: ".فاصوليا", price: 3000, img: "img1/ei_1731592911797-removebg-preview.jpg", description: " نص كيلو فاصوليا" },
        { name: "..فاصوليا", price: 1500, img: "img1/ei_1731592911797-removebg-preview.jpg", description: "ربع كيلو فاصوليا" },
        { name: "عدس", price: 3500, img: "img1/ei_1731592849739-removebg-preview.jpg", description: "كيلو عدس" },
        { name: ".عدس", price: 1800, img: "img1/ei_1731592849739-removebg-preview.jpg", description: "نص كيلو عدس" },
        { name: "..عدس", price: 1000, img: "img1/ei_1731592849739-removebg-preview.jpg", description: "ربع كيلو عدس" },
        ...
        { name: "بصل", price: 1000, img: "img/onions-1397037_1920 (1).jpg", description: "ملوة بصل" },
        { name: ".بصل", price: 2000, img: "img/onions-1397037_1920 (1).jpg", description: "نص ربع بصل" },
        { name: "..بصل", price: 4000, img: "img/onions-1397037_1920 (1).jpg", description: "ربع بصل" },
        ...
        { name: "جبنه رودس", price: 2000, img: "img/ei_1731750070992-removebg-preview.jpg", description: "جبنة رودس يمكنك الاختيار عدة مرات" },    
        ...
        { name: ".زيت رويال", price: 26000, img: "img1/IMG_٢٠٢٥٠٢١٩_١٠٢٨١٢_(600_x_600_pixel).jpg", description: "زيت رويال 4لتر" },
        ...
        { name: "لبن كابو", price: 41000, img: "img/ei_1734696590753-removebg-preview.jpg", description: "لبن كابو 2250جرام" },
        { name: "لبن كابو.", price: 21000, img: "img/ei_1734696662520-removebg-preview.jpg", description: "لبن كابو  1000 جرام" },
        { name: "لبن كابو..", price: 4500, img: "img/ei_1734696472444-removebg-preview.jpg", description: "لبن كابو 200 جرام" },
        { name: "لبن بودره", price: 16000, img: "img/أضرار_الحليب_المجفف.jpg", description: "كيلو لبن بودره" },
        { name: "لبن بودره.", price: 8000, img: "img/أضرار_الحليب_المجفف.jpg", description: "نص كيلو" },
        { name: "لبن بودره..", price: 4000, img: "img/أضرار_الحليب_المجفف.jpg", description: "ربع كيلو" },
        { name: "لبن بودره..", price: 2000, img: "img/أضرار_الحليب_المجفف.jpg", description: "نص ربع كيلو" },
        { name: " بن حب", price: 9000, img: "img1/ei_1731587859083-removebg-preview.jpg", description: "بن رطل" },
        { name: " .بن حب", price: 4500, img: "img1/ei_1731587859083-removebg-preview.jpg", description: "بن نص رطل" },
        { name: "..بن حب", price: 2500, img: "img1/ei_1731587859083-removebg-preview.jpg", description: "بن ربع رطل" },
        { name: ".بن حب.", price: 1500, img: "img1/ei_1731587859083-removebg-preview.jpg", description: "بن نص ربع رطل" },
        { name: "بن مسحون", price: 10000, img: "img1/ei_1731587685380-removebg-preview.jpg", description: "رطل بن مسحون" },
        { name: ".بن مسحون", price: 5000, img: "img1/ei_1731587685380-removebg-preview.jpg", description: "نص رطل بن مسحون" },
        { name: "..بن مسحون", price: 2500, img: "img1/ei_1731587685380-removebg-preview.jpg", description: "ربع رطل بن مسحون" },
        { name: ".بن مسحون.", price: 1500, img: "img1/ei_1731587685380-removebg-preview.jpg", description: "نص ربع رطل بن مسحون" },
        
        { name: "شاي الغزالتين", price: 2000, img: "img1/ei_1731601395773-removebg-preview (1).jpg", description: "ربع شاي الغزالتين" },
        { name: ".شاي الغزالتين", price: 4000, img: "img1/ei_1731601395773-removebg-preview (1).jpg", description: "نص رطل" },
        { name: "..شاي الغزالتين", price: 8000, img: "img1/ei_1731601395773-removebg-preview (1).jpg", description: "رطل شاي الغزالتين" },
